...
helm install azure-samples/aks-helloworld --namespace kube-system --generate-name
#INSTALL 2ND SERVICE
helm install azure-samples/aks-helloworld --namespace kube-system  --generate-name --set title="AKS Ingress Demo" --set serviceName="ingress-demo"
